...
[CustomEditor(typeof(ExplosiveShockWave))]
class ExplosiveShockWaveGUI : Editor
{
    SerializedProperty ShockWaveTime;
    ...
    {
        ShockWaveTime = serializedObject.FindProperty("ShockWaveTime");
    ...
    void OnSceneGUI()
    {
        ExplosiveShockWave explosion = (ExplosiveShockWave)target;
        if (explosion == null)
        {
            return;
        }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(ShockWaveTime, new GUIContent("Shockwave duration", "The duration of the shockwave in seconds."));
