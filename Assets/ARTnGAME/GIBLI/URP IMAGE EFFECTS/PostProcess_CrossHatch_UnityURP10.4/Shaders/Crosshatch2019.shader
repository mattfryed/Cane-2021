...
Shader "Crosshatch 2019"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				//https://github.com/Unity-Technologies/Graphics/blob/632f80e011f18ea537ee6e2f0be3ff4f4dea6a11/Packages/com.unity.render-pipelines.universal/Runtime/RendererFeatures/ScreenSpaceAmbientOcclusion.cs
				float4 _ScaleBiasRt = float4(-1, 1.0f, -1.0f, 1.0f);
						 ...
						 ) : SV_Target
			{
				...
				inputData.bakedGI = SAMPLE_GI( IN.lightmapUVOrVertexSH.xy, SH, inputData.normalWS );
					...
					float2 normalizedUV = GetNormalizedScreenSpaceUV(inputData.positionWS.xyzz);
				
					//inputData.normalizedScreenSpaceUV = normalizedUV;// GetNormalizedScreenSpaceUV(IN.clipPos);
